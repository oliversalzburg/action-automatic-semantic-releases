...
| <a name="input_merge_similar"></a>[merge_similar](#input_merge_similar)                         | string | false    | `"false"` | Should similar changes be consolidated <br>to take up less space <br>in the changelog?    |
